...
import { getAllSesiLatihan, getLatihan, getSiswa } from "../../../../lib/data";
import SesiLatihanTable from "@/app/components/dashboard/sesi-latihan/SesiLatihanTable";
import Pagination from "@/app/components/dashboard/sesi-latihan/Paginitation";
import Search from "@/app/components/dashboard/sesi-latihan/Search";
...
function SesiLatihanPage() {
  const [sesiLatihan, setSesiLatihan] = useState([]);
  ...
  const fetchSesiLatihan = async () => {
    setLoading(true);
    try {
      const { data, totalPages } = await getAllSesiLatihan(currentPage, itemsPerPage);
      setSesiLatihan(data);
